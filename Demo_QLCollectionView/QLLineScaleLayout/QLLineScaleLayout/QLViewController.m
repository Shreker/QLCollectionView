...
- (void)loadDefaultSetting {
    ...
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 100, QLScreenWidth, 200) collectionViewLayout:[[QLLineScaleFlowLayout alloc] init]];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if ([_collectionView.collectionViewLayout isKindOfClass:[QLLineScaleFlowLayout class]]) {
        [_collectionView setCollectionViewLayout:[[UICollectionViewFlowLayout alloc] init] animated:YES];
    } else {
        [_collectionView setCollectionViewLayout:[[QLLineScaleFlowLayout alloc] init] animated:YES];
    }
}
